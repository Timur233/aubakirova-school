...
register_nav_menus(
	array(
		'main-header__bottom' => 'Шапка сайта',
	)
);
...
function atg_menu_classes($classes, $item, $args) {
  ...
  if (in_array('current-menu-item', $classes_old)) {
    $classes[] = 'main-menu__item--active';
  }

  if (in_array('menu-item-has-children', $classes_old)) {
    $classes[] = 'main-menu__item--has-childs';
  }
...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			$classes = array( 'main-menu__sub-menu sub-menu' );
			/**
			...
			/*
			 * The `.main-menu__sub-menu.sub-menu` container needs to have a labelledby
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			if ( $this->has_children && 0 === $depth ) {
				...
				$atts['class']         = 'main-menu__link dropdown-toggle nav-link';
